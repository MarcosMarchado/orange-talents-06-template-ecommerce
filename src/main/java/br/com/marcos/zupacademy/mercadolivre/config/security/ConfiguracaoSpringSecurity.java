...
public class ConfiguracaoSpringSecurity extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private PegarUsuarioQueEstaSeAutenticando pegarUsuarioQueEstaSeAutenticando;

    @Override
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(pegarUsuarioQueEstaSeAutenticando).passwordEncoder(new BCryptPasswordEncoder());
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .and()
                .addFilterBefore(new AutenticacaoViaTokenFilter(tokenConfig, usuarioRepository),
